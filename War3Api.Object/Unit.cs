...
namespace War3Api.Object
{
    public sealed class Unit : BaseObject
    {
        ...
        public Unit(UnitType unitType, ObjectDatabase db): this((int)unitType, db)
        {
        }

        public Unit(UnitType unitType, int newId, ObjectDatabase db): this((int)unitType, newId, db)
        {
        }

        public Unit(UnitType unitType, string newRawcode, ObjectDatabase db): this((int)unitType, newRawcode, db)
        {
        }
