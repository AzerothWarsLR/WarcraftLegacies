...
namespace War3Api.Object
{
    public sealed class Buff : BaseObject
    {
        ...
        public Buff(BuffType buffType, ObjectDatabase db): this((int)buffType, db)
        {
        }

        public Buff(BuffType buffType, int newId, ObjectDatabase db): this((int)buffType, newId, db)
        {
        }

        public Buff(BuffType buffType, string newRawcode, ObjectDatabase db): this((int)buffType, newRawcode, db)
        {
        }
