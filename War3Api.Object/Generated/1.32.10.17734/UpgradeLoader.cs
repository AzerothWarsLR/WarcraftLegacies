...
namespace War3Api.Object
{
    internal class UpgradeLoader
    {
        protected virtual Upgrade LoadHumanMeleeAttack(ObjectDatabaseBase db)
        {
            ...
            upgrade.DataEffect1Raw = "ratd";
            upgrade.Database1 = 1f;
            upgrade.Datamod1 = 1f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
            upgrade.Datamod3 = 0f;
            upgrade.Datacode3 = "-";
            upgrade.DataEffect4Raw = "_";
            upgrade.Database4 = 0f;
            upgrade.Datamod4 = 0f;
            upgrade.Datacode4 = "-";
        ...
        protected virtual Upgrade LoadHumanHammerBounce(ObjectDatabaseBase db)
        {
            ...
            upgrade.DataEffect1Raw = "rasd";
            upgrade.Database1 = 200f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
        ...
        protected virtual Upgrade LoadHumanArmor(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 60;
            upgrade.StatsTimeIncrement = 15;
            upgrade.DataEffect1Raw = "rarm";
            upgrade.Database1 = 0f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
        ...
        protected virtual Upgrade LoadHumanGyroBombs(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "renw";
            upgrade.Database1 = 3f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
        ...
        protected virtual Upgrade LoadHumanArchitecture(ObjectDatabaseBase db)
        {
            ...
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "rhpo";
            upgrade.Database2 = 0.1f;
            upgrade.Datamod2 = 0.1f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
            upgrade.Datamod3 = 0f;
        ...
        protected virtual Upgrade LoadHumanAnimalBreeding(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "rhpx";
            upgrade.Database1 = 100f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
        ...
        protected virtual Upgrade LoadHumanPriestTraining(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 60;
            upgrade.StatsTimeIncrement = 15;
            upgrade.DataEffect1Raw = "rmnx";
            upgrade.Database1 = 100f;
            upgrade.Datamod1 = 100f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "rmnr";
            upgrade.Database2 = 0.325f;
            upgrade.Datamod2 = 0.325f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "rhpx";
            upgrade.Database3 = 40f;
            upgrade.Datamod3 = 40f;
            upgrade.Datacode3 = "-";
            upgrade.DataEffect4Raw = "ratd";
            upgrade.Database4 = 0f;
            upgrade.Datamod4 = 0f;
            upgrade.Datacode4 = "-";
            upgrade.StatsTransferWithUnitOwnershipRaw = 1;
        ...
        protected virtual Upgrade LoadHumanRiflemanPlusRange(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "ratr";
            upgrade.Database1 = 200f;
            upgrade.Datamod1 = 200f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
            upgrade.Datamod2 = 0f;
        ...
        protected virtual Upgrade LoadHumanLumberHarvesting(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 60;
            upgrade.StatsTimeIncrement = 15;
            upgrade.DataEffect1Raw = "rlum";
            upgrade.Database1 = 10f;
            upgrade.Datamod1 = 10f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "rlev";
            upgrade.Database2 = 1f;
            upgrade.Datamod2 = 1f;
            upgrade.Datacode2 = "Ahlh";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
            upgrade.Datamod3 = 0f;
            upgrade.Datacode3 = "-";
        ...
        protected virtual Upgrade LoadHumanRocketTank(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 40;
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "rtma";
            upgrade.Database1 = 1f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "hmtt";
            upgrade.DataEffect2Raw = "rtma";
            upgrade.Database2 = -1f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "hrtt";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
            upgrade.Datamod3 = 0f;
            upgrade.Datacode3 = "-";
        ...
        protected virtual Upgrade LoadOrcWarDrumsDamage(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 40;
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "raud";
            upgrade.Database1 = 0.1f;
            upgrade.Datamod1 = 0.1f;
            upgrade.Datacode1 = "Aakb";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
        ...
        protected virtual Upgrade LoadOrcGruntBerserk(ObjectDatabaseBase db)
        {
            ...
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "ratx";
            upgrade.Database2 = 3f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
        ...
        protected virtual Upgrade LoadOrcTaurenSmash(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 40;
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "rlev";
            upgrade.Database1 = 1f;
            upgrade.Datamod1 = 1f;
            upgrade.Datacode1 = "Awar";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
        ...
        protected virtual Upgrade LoadOrcSpikedBarricade(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 60;
            upgrade.StatsTimeIncrement = 15;
            upgrade.DataEffect1Raw = "rspi";
            upgrade.Database1 = 5f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "rspp";
            upgrade.Database2 = 0.2f;
            upgrade.Datamod2 = 0.3f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "rlev";
            upgrade.Database3 = 1f;
            upgrade.Datamod3 = 1f;
            upgrade.Datacode3 = "Aosp";
            upgrade.DataEffect4Raw = "_";
            upgrade.Database4 = 0f;
            upgrade.Datamod4 = 0f;
            upgrade.Datacode4 = "-";
        ...
        protected virtual Upgrade LoadOrcSpiritwalkerTraining(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeIncrement = 15;
            upgrade.DataEffect1Raw = "rmnx";
            upgrade.Database1 = 150f;
            upgrade.Datamod1 = 150f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "rmnr";
            upgrade.Database2 = 0.42f;
            upgrade.Datamod2 = 0.42f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "rhpx";
            upgrade.Database3 = 60f;
            upgrade.Datamod3 = 60f;
            upgrade.Datacode3 = "-";
            upgrade.DataEffect4Raw = "ratd";
            upgrade.Database4 = 0f;
            upgrade.Datamod4 = 0f;
        ...
        protected virtual Upgrade LoadOrcBerserkers(ObjectDatabaseBase db)
        {
            ...
            upgrade.Database1 = 1f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "ohun";
            upgrade.DataEffect2Raw = "rtma";
            upgrade.Database2 = -1f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "otbk";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
            upgrade.Datamod3 = 0f;
            upgrade.Datacode3 = "-";
        ...
        protected virtual Upgrade LoadUndeadGhoulFrenzy(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 45;
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "rats";
            upgrade.Database1 = 0.35f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "rmvx";
            upgrade.Database2 = 80f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
        ...
        protected virtual Upgrade LoadUndeadSkeletonLifeSpan(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "rrai";
            upgrade.Database1 = 20f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
        ...
        protected virtual Upgrade LoadUndeadSkeletalMastery(ObjectDatabaseBase db)
        {
            ...
            upgrade.Database1 = 1f;
            upgrade.Datamod1 = 1f;
            upgrade.Datacode1 = "Arai";
            upgrade.DataEffect2Raw = "rrai";
            upgrade.Database2 = 20f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
        ...
        protected virtual Upgrade LoadNightelfNatureSBlessing(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 60;
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "rmvx";
            upgrade.Database1 = 40f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "rarm";
            upgrade.Database2 = 0f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "_";
        ...
        protected virtual Upgrade LoadNightelfMarksmanship(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeBase = 40;
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "ratx";
            upgrade.Database1 = 4f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "_";
            upgrade.Database2 = 0f;
        ...
        protected virtual Upgrade LoadNightelfDoCTraining(ObjectDatabaseBase db)
        {
            ...
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "rhpx";
            upgrade.Database3 = 75f;
            upgrade.Datamod3 = 75f;
            upgrade.Datacode3 = "-";
            upgrade.DataEffect4Raw = "ratd";
            upgrade.Database4 = 1f;
            upgrade.Datamod4 = 1f;
            upgrade.Datacode4 = "-";
            upgrade.StatsTransferWithUnitOwnershipRaw = 1;
            upgrade.StatsAppliesToAllUnitsRaw = 0;
        ...
        protected virtual Upgrade LoadNightelfImpalingBolt(ObjectDatabaseBase db)
        {
            ...
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "renw";
            upgrade.Database2 = 2f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
        ...
        protected virtual Upgrade LoadNightelfWellSpring(ObjectDatabaseBase db)
        {
            ...
            upgrade.StatsTimeIncrement = 0;
            upgrade.DataEffect1Raw = "rmnx";
            upgrade.Database1 = 125f;
            upgrade.Datamod1 = 0f;
            upgrade.Datacode1 = "-";
            upgrade.DataEffect2Raw = "rmnr";
            upgrade.Database2 = 0.52f;
            upgrade.Datamod2 = 0f;
            upgrade.Datacode2 = "-";
            upgrade.DataEffect3Raw = "_";
            upgrade.Database3 = 0f;
