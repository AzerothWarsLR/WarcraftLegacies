...
{
    public sealed class TinkererDemolishLevel0 : Ability
    {
        ...
        public TinkererDemolishLevel0(): base(1701072449)
        {
        ...
        public TinkererDemolishLevel0(int newId): base(1701072449, newId)
        {
            _dataChanceToDemolish = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataChanceToDemolish, SetDataChanceToDemolish));
            _isDataChanceToDemolishModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataChanceToDemolishModified));
            _dataDamageMultiplierBuildings = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamageMultiplierBuildings, SetDataDamageMultiplierBuildings));
        ...
        public TinkererDemolishLevel0(string newRawcode): base(1701072449, newRawcode)
        {
            _dataChanceToDemolish = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataChanceToDemolish, SetDataChanceToDemolish));
            _isDataChanceToDemolishModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataChanceToDemolishModified));
            _dataDamageMultiplierBuildings = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamageMultiplierBuildings, SetDataDamageMultiplierBuildings));
        ...
        public TinkererDemolishLevel0(ObjectDatabaseBase db): base(1701072449, db)
        {
            _dataChanceToDemolish = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataChanceToDemolish, SetDataChanceToDemolish));
            _isDataChanceToDemolishModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataChanceToDemolishModified));
            _dataDamageMultiplierBuildings = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamageMultiplierBuildings, SetDataDamageMultiplierBuildings));
        ...
        public TinkererDemolishLevel0(int newId, ObjectDatabaseBase db): base(1701072449, newId, db)
        {
            _dataChanceToDemolish = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataChanceToDemolish, SetDataChanceToDemolish));
            _isDataChanceToDemolishModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataChanceToDemolishModified));
            _dataDamageMultiplierBuildings = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamageMultiplierBuildings, SetDataDamageMultiplierBuildings));
        ...
        public TinkererDemolishLevel0(string newRawcode, ObjectDatabaseBase db): base(1701072449, newRawcode, db)
        {
            _dataChanceToDemolish = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataChanceToDemolish, SetDataChanceToDemolish));
            _isDataChanceToDemolishModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataChanceToDemolishModified));
            _dataDamageMultiplierBuildings = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamageMultiplierBuildings, SetDataDamageMultiplierBuildings));
