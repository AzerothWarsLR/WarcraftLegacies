...
namespace War3Api.Object
{
    public sealed class Doodad : BaseObject
    {
        ...
        public Doodad(DoodadType doodadType, ObjectDatabase db): this((int)doodadType, db)
        {
        }

        public Doodad(DoodadType doodadType, int newId, ObjectDatabase db): this((int)doodadType, newId, db)
        {
        }

        public Doodad(DoodadType doodadType, string newRawcode, ObjectDatabase db): this((int)doodadType, newRawcode, db)
        {
        }
