...
namespace War3Api.Object
{
    ...
    {
        private readonly LevelObjectDataModifications _modifications = new LevelObjectDataModifications();
        ...
        public Upgrade(UpgradeType upgradeType, ObjectDatabase db): this((int)upgradeType, db)
        {
        }

        public Upgrade(UpgradeType upgradeType, int newId, ObjectDatabase db): this((int)upgradeType, newId, db)
        {
        }

        public Upgrade(UpgradeType upgradeType, string newRawcode, ObjectDatabase db): this((int)upgradeType, newRawcode, db)
        {
        }
        ...
        private Upgrade(int oldId, ObjectDatabase db): base(oldId, db)
        {
            _textName = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetTextName, SetTextName));
            _isTextNameModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsTextNameModified));
            _textEditorSuffix = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetTextEditorSuffix, SetTextEditorSuffix));
        ...
        private Upgrade(int oldId, int newId, ObjectDatabase db): base(oldId, newId, db)
        {
            _textName = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetTextName, SetTextName));
            _isTextNameModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsTextNameModified));
            _textEditorSuffix = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetTextEditorSuffix, SetTextEditorSuffix));
        ...
        private Upgrade(int oldId, string newRawcode, ObjectDatabase db): base(oldId, newRawcode, db)
        {
            _textName = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetTextName, SetTextName));
            _isTextNameModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsTextNameModified));
            _textEditorSuffix = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetTextEditorSuffix, SetTextEditorSuffix));
        ...
        {
            get => _modifications[1667330663].ValueAsString;
        ...
        {
            get => _modifications[2037408359].ValueAsInt;
        ...
        {
            get => _modifications[1936483175].ValueAsString;
        ...
        {
            get => _modifications[1819700327].ValueAsInt;
        ...
        {
            get => _modifications[1651271527].ValueAsInt;
        ...
        {
            get => _modifications[1835820903].ValueAsInt;
        ...
        {
            get => _modifications[1651338343].ValueAsInt;
        ...
        {
            get => _modifications[1835887719].ValueAsInt;
        ...
        {
            get => _modifications[1651078247].ValueAsInt;
        ...
        {
            get => _modifications[1835627623].ValueAsInt;
        ...
        public string DataEffect1Raw
        {
            get => _modifications[828794215].ValueAsString;
            set => _modifications[828794215] = new LevelObjectDataModification{Id = 828794215, Type = ObjectDataType.String, Value = value, Level = 0};
        }

        public bool IsDataEffect1Modified => _modifications.ContainsKey(828794215);
        public UpgradeEffect DataEffect1
        {
            get => DataEffect1Raw.ToUpgradeEffect(this);
            set => DataEffect1Raw = value.ToRaw(null, null);
        }

        public float DataBase1
        {
            get => _modifications[828465767].ValueAsFloat;
        ...
        {
            get => _modifications[829386087].ValueAsFloat;
        ...
        {
            get => _modifications[829383527].ValueAsString;
        ...
        {
            get => _modifications[845571431].ValueAsString;
            set => _modifications[845571431] = new LevelObjectDataModification{Id = 845571431, Type = ObjectDataType.String, Value = value, Level = 0};
        }

        public bool IsDataEffect2Modified => _modifications.ContainsKey(845571431);
        public UpgradeEffect DataEffect2
        {
            get => DataEffect2Raw.ToUpgradeEffect(this);
            set => DataEffect2Raw = value.ToRaw(null, null);
        }

        public float DataBase2
        {
            get => _modifications[845242983].ValueAsFloat;
        ...
        {
            get => _modifications[846163303].ValueAsFloat;
        ...
        {
            get => _modifications[846160743].ValueAsString;
        ...
        {
            get => _modifications[862348647].ValueAsString;
            set => _modifications[862348647] = new LevelObjectDataModification{Id = 862348647, Type = ObjectDataType.String, Value = value, Level = 0};
        }

        public bool IsDataEffect3Modified => _modifications.ContainsKey(862348647);
        public UpgradeEffect DataEffect3
        {
            get => DataEffect3Raw.ToUpgradeEffect(this);
            set => DataEffect3Raw = value.ToRaw(null, null);
        }

        public float DataBase3
        {
            get => _modifications[862020199].ValueAsFloat;
        ...
        {
            get => _modifications[862940519].ValueAsFloat;
        ...
        {
            get => _modifications[862937959].ValueAsString;
        ...
        {
            get => _modifications[879125863].ValueAsString;
            set => _modifications[879125863] = new LevelObjectDataModification{Id = 879125863, Type = ObjectDataType.String, Value = value, Level = 0};
        }

        public bool IsDataEffect4Modified => _modifications.ContainsKey(879125863);
        public UpgradeEffect DataEffect4
        {
            get => DataEffect4Raw.ToUpgradeEffect(this);
            set => DataEffect4Raw = value.ToRaw(null, null);
        }

        public float DataBase4
        {
            get => _modifications[878797415].ValueAsFloat;
        ...
        {
            get => _modifications[879717735].ValueAsFloat;
        ...
        {
            get => _modifications[879715175].ValueAsString;
        ...
        {
            return _modifications[1835101799, level].ValueAsString;
        }
        ...
        {
            return _modifications[1718840935, level].ValueAsString;
        }
        ...
        {
            return _modifications[829453415, level].ValueAsString;
        }
        ...
        {
            return _modifications[828536167, level].ValueAsString;
        }
        ...
        {
            return _modifications[829579623, level].ValueAsString;
        }
        ...
        {
            return _modifications[1902473831, level].ValueAsString;
        }
        ...
        {
            return _modifications[1668379239, level].ValueAsString;
        }
