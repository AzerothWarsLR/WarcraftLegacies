...
library SpawnTentacle4 initializer OnInit requires T32

    globals
        private constant integer UNIT4_ID = 'U02C'
        private constant integer TENTACLE_COUNT_BASE = 3
        private constant integer TENTACLE3_ID = 'n0B8'
        private constant real RADIUS_OFFSET = 300.  //How far away from the caster to position the Tentacles
    endglobals    

    struct tentacleAppendageSet4
    ...
    private function Built takes nothing returns nothing
        local tentacleAppendageSet4 temptentacleAppendageSet4 = 0
        local unit triggerUnit = null
        local integer triggerUnitHandleId = 0
            set triggerUnit = gg_unit_U02C_2829
            set triggerUnitHandleId = UNIT4_ID
            set temptentacleAppendageSet4 = tentacleAppendageSet4.tentacleSetsByCasterHandleId[triggerUnitHandleId]
            if temptentacleAppendageSet4 == 0 then
                set temptentacleAppendageSet4 = tentacleAppendageSet4.create(triggerUnit)
                set tentacleAppendageSet4.tentacleSetsByCasterHandleId[triggerUnitHandleId] = temptentacleAppendageSet4
            endif
