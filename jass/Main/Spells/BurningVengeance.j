...
library BurningVengeance initializer OnInit requires Table, FilteredDamageEvents

  globals
    private constant integer HERO_ID = 'O04H' //The hero that can use Take Vengeance

    private constant integer ABIL_ID = 'A0OO'
    private constant integer ALTERNATE_FORM_ID = 'e01A'
