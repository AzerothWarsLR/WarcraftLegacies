library WarStompImmoltar initializer OnInit requires DummyCast, Filters

  globals
    private constant integer ABIL_ID        = 'A0LU'
    ...
    private constant real    DAMAGE         = 9000
    private constant real    RADIUS         = 200.00
