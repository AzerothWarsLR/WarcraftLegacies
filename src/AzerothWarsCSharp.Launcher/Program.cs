  ...
  internal static class Program
  {
    ...
    private static void Build(string baseMapPath, string projectFolderPath, bool launch)
    {
      // Ensure these folders exist
			...
			var compiler = new Compiler(csproj, OUTPUT_FOLDER_PATH, string.Empty, null, "War3Api.Blizzard.*;War3Api.Common.*;WCSharp.*;AzerothWarsCSharp.MacroTools.*", "", csc, false, null, string.Empty)
			{
