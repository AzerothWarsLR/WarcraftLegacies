...
{
    public sealed class FigurineRockGolem : Ability
    {
        ...
        public FigurineRockGolem(): base(1919306049)
        {
        ...
        public FigurineRockGolem(int newId): base(1919306049, newId)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
        ...
        public FigurineRockGolem(string newRawcode): base(1919306049, newRawcode)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
        ...
        public FigurineRockGolem(ObjectDatabaseBase db): base(1919306049, db)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
        ...
        public FigurineRockGolem(int newId, ObjectDatabaseBase db): base(1919306049, newId, db)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
        ...
        public FigurineRockGolem(string newRawcode, ObjectDatabaseBase db): base(1919306049, newRawcode, db)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
