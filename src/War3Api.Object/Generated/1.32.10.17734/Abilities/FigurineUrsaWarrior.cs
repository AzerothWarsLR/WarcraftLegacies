...
{
    public sealed class FigurineUrsaWarrior : Ability
    {
        ...
        public FigurineUrsaWarrior(): base(2004175169)
        {
        ...
        public FigurineUrsaWarrior(int newId): base(2004175169, newId)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
        ...
        public FigurineUrsaWarrior(string newRawcode): base(2004175169, newRawcode)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
        ...
        public FigurineUrsaWarrior(ObjectDatabaseBase db): base(2004175169, db)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
        ...
        public FigurineUrsaWarrior(int newId, ObjectDatabaseBase db): base(2004175169, newId, db)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
        ...
        public FigurineUrsaWarrior(string newRawcode, ObjectDatabaseBase db): base(2004175169, newRawcode, db)
        {
            _dataSummon1Amount = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataSummon1Amount, SetDataSummon1Amount));
            _isDataSummon1AmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataSummon1AmountModified));
            _dataSummon1UnitTypeRaw = new Lazy<ObjectProperty<string>>(() => new ObjectProperty<string>(GetDataSummon1UnitTypeRaw, SetDataSummon1UnitTypeRaw));
