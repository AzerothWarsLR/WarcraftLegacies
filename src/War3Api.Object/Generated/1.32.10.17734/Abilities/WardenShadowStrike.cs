...
{
    public sealed class WardenShadowStrike : Ability
    {
        ...
        public WardenShadowStrike(): base(1752384833)
        {
        ...
        public WardenShadowStrike(int newId): base(1752384833, newId)
        {
            _dataDecayingDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDecayingDamage, SetDataDecayingDamage));
            _isDataDecayingDamageModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataDecayingDamageModified));
            _dataMovementSpeedFactor = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMovementSpeedFactor, SetDataMovementSpeedFactor));
        ...
        public WardenShadowStrike(string newRawcode): base(1752384833, newRawcode)
        {
            _dataDecayingDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDecayingDamage, SetDataDecayingDamage));
            _isDataDecayingDamageModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataDecayingDamageModified));
            _dataMovementSpeedFactor = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMovementSpeedFactor, SetDataMovementSpeedFactor));
        ...
        public WardenShadowStrike(ObjectDatabaseBase db): base(1752384833, db)
        {
            _dataDecayingDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDecayingDamage, SetDataDecayingDamage));
            _isDataDecayingDamageModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataDecayingDamageModified));
            _dataMovementSpeedFactor = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMovementSpeedFactor, SetDataMovementSpeedFactor));
        ...
        public WardenShadowStrike(int newId, ObjectDatabaseBase db): base(1752384833, newId, db)
        {
            _dataDecayingDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDecayingDamage, SetDataDecayingDamage));
            _isDataDecayingDamageModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataDecayingDamageModified));
            _dataMovementSpeedFactor = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMovementSpeedFactor, SetDataMovementSpeedFactor));
        ...
        public WardenShadowStrike(string newRawcode, ObjectDatabaseBase db): base(1752384833, newRawcode, db)
        {
            _dataDecayingDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDecayingDamage, SetDataDecayingDamage));
            _isDataDecayingDamageModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataDecayingDamageModified));
            _dataMovementSpeedFactor = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMovementSpeedFactor, SetDataMovementSpeedFactor));
