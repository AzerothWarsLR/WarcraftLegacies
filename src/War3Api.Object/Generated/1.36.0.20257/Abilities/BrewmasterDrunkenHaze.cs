...
{
    public sealed class BrewmasterDrunkenHaze : Ability
    {
        ...
        public BrewmasterDrunkenHaze(): base(1751404097)
        {
        ...
        public BrewmasterDrunkenHaze(int newId): base(1751404097, newId)
        {
            _dataAttacksPreventedRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataAttacksPreventedRaw, SetDataAttacksPreventedRaw));
            _isDataAttacksPreventedModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAttacksPreventedModified));
            _dataAttacksPrevented = new Lazy<ObjectProperty<SilenceFlags>>(() => new ObjectProperty<SilenceFlags>(GetDataAttacksPrevented, SetDataAttacksPrevented));
        ...
        public BrewmasterDrunkenHaze(string newRawcode): base(1751404097, newRawcode)
        {
            _dataAttacksPreventedRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataAttacksPreventedRaw, SetDataAttacksPreventedRaw));
            _isDataAttacksPreventedModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAttacksPreventedModified));
            _dataAttacksPrevented = new Lazy<ObjectProperty<SilenceFlags>>(() => new ObjectProperty<SilenceFlags>(GetDataAttacksPrevented, SetDataAttacksPrevented));
        ...
        public BrewmasterDrunkenHaze(ObjectDatabaseBase db): base(1751404097, db)
        {
            _dataAttacksPreventedRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataAttacksPreventedRaw, SetDataAttacksPreventedRaw));
            _isDataAttacksPreventedModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAttacksPreventedModified));
            _dataAttacksPrevented = new Lazy<ObjectProperty<SilenceFlags>>(() => new ObjectProperty<SilenceFlags>(GetDataAttacksPrevented, SetDataAttacksPrevented));
        ...
        public BrewmasterDrunkenHaze(int newId, ObjectDatabaseBase db): base(1751404097, newId, db)
        {
            _dataAttacksPreventedRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataAttacksPreventedRaw, SetDataAttacksPreventedRaw));
            _isDataAttacksPreventedModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAttacksPreventedModified));
            _dataAttacksPrevented = new Lazy<ObjectProperty<SilenceFlags>>(() => new ObjectProperty<SilenceFlags>(GetDataAttacksPrevented, SetDataAttacksPrevented));
        ...
        public BrewmasterDrunkenHaze(string newRawcode, ObjectDatabaseBase db): base(1751404097, newRawcode, db)
        {
            _dataAttacksPreventedRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataAttacksPreventedRaw, SetDataAttacksPreventedRaw));
            _isDataAttacksPreventedModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAttacksPreventedModified));
            _dataAttacksPrevented = new Lazy<ObjectProperty<SilenceFlags>>(() => new ObjectProperty<SilenceFlags>(GetDataAttacksPrevented, SetDataAttacksPrevented));
