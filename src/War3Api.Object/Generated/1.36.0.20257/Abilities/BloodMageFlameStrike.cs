...
{
    public sealed class BloodMageFlameStrike : Ability
    {
        ...
        public BloodMageFlameStrike(): base(1936083009)
        {
        ...
        public BloodMageFlameStrike(int newId): base(1936083009, newId)
        {
            _dataFullDamageDealt = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageDealt, SetDataFullDamageDealt));
            _isDataFullDamageDealtModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataFullDamageDealtModified));
            _dataFullDamageInterval = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageInterval, SetDataFullDamageInterval));
        ...
        public BloodMageFlameStrike(string newRawcode): base(1936083009, newRawcode)
        {
            _dataFullDamageDealt = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageDealt, SetDataFullDamageDealt));
            _isDataFullDamageDealtModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataFullDamageDealtModified));
            _dataFullDamageInterval = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageInterval, SetDataFullDamageInterval));
        ...
        public BloodMageFlameStrike(ObjectDatabaseBase db): base(1936083009, db)
        {
            _dataFullDamageDealt = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageDealt, SetDataFullDamageDealt));
            _isDataFullDamageDealtModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataFullDamageDealtModified));
            _dataFullDamageInterval = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageInterval, SetDataFullDamageInterval));
        ...
        public BloodMageFlameStrike(int newId, ObjectDatabaseBase db): base(1936083009, newId, db)
        {
            _dataFullDamageDealt = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageDealt, SetDataFullDamageDealt));
            _isDataFullDamageDealtModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataFullDamageDealtModified));
            _dataFullDamageInterval = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageInterval, SetDataFullDamageInterval));
        ...
        public BloodMageFlameStrike(string newRawcode, ObjectDatabaseBase db): base(1936083009, newRawcode, db)
        {
            _dataFullDamageDealt = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageDealt, SetDataFullDamageDealt));
            _isDataFullDamageDealtModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataFullDamageDealtModified));
            _dataFullDamageInterval = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataFullDamageInterval, SetDataFullDamageInterval));
