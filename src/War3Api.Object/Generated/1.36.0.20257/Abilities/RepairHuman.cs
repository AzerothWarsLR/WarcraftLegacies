...
{
    public sealed class RepairHuman : Ability
    {
        ...
        public RepairHuman(): base(1886545985)
        {
        ...
        public RepairHuman(int newId): base(1886545985, newId)
        {
            _dataRepairCostRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairCostRatio, SetDataRepairCostRatio));
            _isDataRepairCostRatioModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataRepairCostRatioModified));
            _dataRepairTimeRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairTimeRatio, SetDataRepairTimeRatio));
        ...
        public RepairHuman(string newRawcode): base(1886545985, newRawcode)
        {
            _dataRepairCostRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairCostRatio, SetDataRepairCostRatio));
            _isDataRepairCostRatioModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataRepairCostRatioModified));
            _dataRepairTimeRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairTimeRatio, SetDataRepairTimeRatio));
        ...
        public RepairHuman(ObjectDatabaseBase db): base(1886545985, db)
        {
            _dataRepairCostRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairCostRatio, SetDataRepairCostRatio));
            _isDataRepairCostRatioModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataRepairCostRatioModified));
            _dataRepairTimeRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairTimeRatio, SetDataRepairTimeRatio));
        ...
        public RepairHuman(int newId, ObjectDatabaseBase db): base(1886545985, newId, db)
        {
            _dataRepairCostRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairCostRatio, SetDataRepairCostRatio));
            _isDataRepairCostRatioModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataRepairCostRatioModified));
            _dataRepairTimeRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairTimeRatio, SetDataRepairTimeRatio));
        ...
        public RepairHuman(string newRawcode, ObjectDatabaseBase db): base(1886545985, newRawcode, db)
        {
            _dataRepairCostRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairCostRatio, SetDataRepairCostRatio));
            _isDataRepairCostRatioModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataRepairCostRatioModified));
            _dataRepairTimeRatio = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataRepairTimeRatio, SetDataRepairTimeRatio));
