...
{
    public sealed class PitLordRainOfFire : Ability
    {
        ...
        public PitLordRainOfFire(): base(1718767169)
        {
        ...
        public PitLordRainOfFire(int newId): base(1718767169, newId)
        {
            _dataNumberOfWaves = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataNumberOfWaves, SetDataNumberOfWaves));
            _isDataNumberOfWavesModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataNumberOfWavesModified));
            _dataDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamage, SetDataDamage));
        ...
        public PitLordRainOfFire(string newRawcode): base(1718767169, newRawcode)
        {
            _dataNumberOfWaves = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataNumberOfWaves, SetDataNumberOfWaves));
            _isDataNumberOfWavesModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataNumberOfWavesModified));
            _dataDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamage, SetDataDamage));
        ...
        public PitLordRainOfFire(ObjectDatabaseBase db): base(1718767169, db)
        {
            _dataNumberOfWaves = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataNumberOfWaves, SetDataNumberOfWaves));
            _isDataNumberOfWavesModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataNumberOfWavesModified));
            _dataDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamage, SetDataDamage));
        ...
        public PitLordRainOfFire(int newId, ObjectDatabaseBase db): base(1718767169, newId, db)
        {
            _dataNumberOfWaves = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataNumberOfWaves, SetDataNumberOfWaves));
            _isDataNumberOfWavesModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataNumberOfWavesModified));
            _dataDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamage, SetDataDamage));
        ...
        public PitLordRainOfFire(string newRawcode, ObjectDatabaseBase db): base(1718767169, newRawcode, db)
        {
            _dataNumberOfWaves = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataNumberOfWaves, SetDataNumberOfWaves));
            _isDataNumberOfWavesModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataNumberOfWavesModified));
            _dataDamage = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamage, SetDataDamage));
