...
namespace War3Api.Object.Abilities
{
    public sealed class AntiMagicShield_AIxs : Ability
    {
        ...
        public AntiMagicShield_AIxs(ObjectDatabaseBase db): base(1937262913, db)
        {
            _dataShieldLife = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataShieldLife, SetDataShieldLife));
            _isDataShieldLifeModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataShieldLifeModified));
            _dataManaLoss = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataManaLoss, SetDataManaLoss));
        ...
        public AntiMagicShield_AIxs(int newId, ObjectDatabaseBase db): base(1937262913, newId, db)
        {
            _dataShieldLife = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataShieldLife, SetDataShieldLife));
            _isDataShieldLifeModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataShieldLifeModified));
            _dataManaLoss = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataManaLoss, SetDataManaLoss));
        ...
        public AntiMagicShield_AIxs(string newRawcode, ObjectDatabaseBase db): base(1937262913, newRawcode, db)
        {
            _dataShieldLife = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataShieldLife, SetDataShieldLife));
            _isDataShieldLifeModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataShieldLifeModified));
            _dataManaLoss = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataManaLoss, SetDataManaLoss));
        ...
        {
            return _modifications.GetModification(829651017, level).ValueAsFloat;
        }
        ...
        {
            return _modifications.ContainsKey(829651017, level);
        }

        private float GetDataMagicDamageReduction(int level)
        {
            return _modifications.GetModification(846428233, level).ValueAsFloat;
        }
        ...
        {
            return _modifications.ContainsKey(846428233, level);
        }
    }
}