...
{
    public sealed class AuraPlaguePlagueWard : Ability
    {
        ...
        public AuraPlaguePlagueWard(): base(846225729)
        {
        ...
        public AuraPlaguePlagueWard(int newId): base(846225729, newId)
        {
            _dataAuraDuration = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataAuraDuration, SetDataAuraDuration));
            _isDataAuraDurationModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAuraDurationModified));
            _dataDamagePerSecond = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamagePerSecond, SetDataDamagePerSecond));
        ...
        public AuraPlaguePlagueWard(string newRawcode): base(846225729, newRawcode)
        {
            _dataAuraDuration = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataAuraDuration, SetDataAuraDuration));
            _isDataAuraDurationModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAuraDurationModified));
            _dataDamagePerSecond = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamagePerSecond, SetDataDamagePerSecond));
        ...
        public AuraPlaguePlagueWard(ObjectDatabaseBase db): base(846225729, db)
        {
            _dataAuraDuration = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataAuraDuration, SetDataAuraDuration));
            _isDataAuraDurationModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAuraDurationModified));
            _dataDamagePerSecond = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamagePerSecond, SetDataDamagePerSecond));
        ...
        public AuraPlaguePlagueWard(int newId, ObjectDatabaseBase db): base(846225729, newId, db)
        {
            _dataAuraDuration = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataAuraDuration, SetDataAuraDuration));
            _isDataAuraDurationModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAuraDurationModified));
            _dataDamagePerSecond = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamagePerSecond, SetDataDamagePerSecond));
        ...
        public AuraPlaguePlagueWard(string newRawcode, ObjectDatabaseBase db): base(846225729, newRawcode, db)
        {
            _dataAuraDuration = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataAuraDuration, SetDataAuraDuration));
            _isDataAuraDurationModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataAuraDurationModified));
            _dataDamagePerSecond = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataDamagePerSecond, SetDataDamagePerSecond));
