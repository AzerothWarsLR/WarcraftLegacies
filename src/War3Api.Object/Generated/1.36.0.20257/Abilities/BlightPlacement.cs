...
{
    public sealed class BlightPlacement : Ability
    {
        ...
        public BlightPlacement(): base(1886151233)
        {
        ...
        public BlightPlacement(int newId): base(1886151233, newId)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
        ...
        public BlightPlacement(string newRawcode): base(1886151233, newRawcode)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
        ...
        public BlightPlacement(ObjectDatabaseBase db): base(1886151233, db)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
        ...
        public BlightPlacement(int newId, ObjectDatabaseBase db): base(1886151233, newId, db)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
        ...
        public BlightPlacement(string newRawcode, ObjectDatabaseBase db): base(1886151233, newRawcode, db)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
