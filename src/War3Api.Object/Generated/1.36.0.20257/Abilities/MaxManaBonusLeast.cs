...
namespace War3Api.Object.Abilities
{
    public sealed class MaxManaBonusLeast : Ability
    {
        ...
        public MaxManaBonusLeast(ObjectDatabaseBase db): base(1651329345, db)
        {
            _dataMaxManaGained = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataMaxManaGained, SetDataMaxManaGained));
            _isDataMaxManaGainedModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataMaxManaGainedModified));
        }

        public MaxManaBonusLeast(int newId, ObjectDatabaseBase db): base(1651329345, newId, db)
        {
            _dataMaxManaGained = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataMaxManaGained, SetDataMaxManaGained));
            _isDataMaxManaGainedModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataMaxManaGainedModified));
        }

        public MaxManaBonusLeast(string newRawcode, ObjectDatabaseBase db): base(1651329345, newRawcode, db)
        {
            _dataMaxManaGained = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataMaxManaGained, SetDataMaxManaGained));
            _isDataMaxManaGainedModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataMaxManaGainedModified));
        }
