...
{
    public sealed class BlightDispelLarge : Ability
    {
        ...
        public BlightDispelLarge(): base(1818518081)
        {
        ...
        public BlightDispelLarge(int newId): base(1818518081, newId)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
        ...
        public BlightDispelLarge(string newRawcode): base(1818518081, newRawcode)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
        ...
        public BlightDispelLarge(ObjectDatabaseBase db): base(1818518081, db)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
        ...
        public BlightDispelLarge(int newId, ObjectDatabaseBase db): base(1818518081, newId, db)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
        ...
        public BlightDispelLarge(string newRawcode, ObjectDatabaseBase db): base(1818518081, newRawcode, db)
        {
            _dataExpansionAmount = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataExpansionAmount, SetDataExpansionAmount));
            _isDataExpansionAmountModified = new Lazy<ReadOnlyObjectProperty<bool>>(() => new ReadOnlyObjectProperty<bool>(GetIsDataExpansionAmountModified));
            _dataCreatesBlightRaw = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataCreatesBlightRaw, SetDataCreatesBlightRaw));
