...
namespace War3Api.Object
{
    public sealed class Upgrade : BaseObject
    {
        ...
        public Upgrade(UpgradeType baseUpgradeType): this((int)baseUpgradeType)
        {
        }

        public Upgrade(UpgradeType baseUpgradeType, int newId): this((int)baseUpgradeType, newId)
        {
        }

        public Upgrade(UpgradeType baseUpgradeType, string newRawcode): this((int)baseUpgradeType, newRawcode)
        {
        }

        public Upgrade(UpgradeType baseUpgradeType, ObjectDatabase db): this((int)baseUpgradeType, db)
        {
        }

        public Upgrade(UpgradeType baseUpgradeType, int newId, ObjectDatabase db): this((int)baseUpgradeType, newId, db)
        {
        }

        public Upgrade(UpgradeType baseUpgradeType, string newRawcode, ObjectDatabase db): this((int)baseUpgradeType, newRawcode, db)
        {
        }
