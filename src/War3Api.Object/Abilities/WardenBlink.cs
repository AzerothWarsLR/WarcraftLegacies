...
namespace War3Api.Object.Abilities
{
    public sealed class WardenBlink : Ability
    {
        ...
        public WardenBlink(ObjectDatabase db): base(1818379585, db)
        {
            _dataMaximumRange = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMaximumRange, SetDataMaximumRange));
            _dataMinimumRange = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMinimumRange, SetDataMinimumRange));
        }

        public WardenBlink(int newId, ObjectDatabase db): base(1818379585, newId, db)
        {
            _dataMaximumRange = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMaximumRange, SetDataMaximumRange));
            _dataMinimumRange = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMinimumRange, SetDataMinimumRange));
        }

        public WardenBlink(string newRawcode, ObjectDatabase db): base(1818379585, newRawcode, db)
        {
            _dataMaximumRange = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMaximumRange, SetDataMaximumRange));
            _dataMinimumRange = new Lazy<ObjectProperty<float>>(() => new ObjectProperty<float>(GetDataMinimumRange, SetDataMinimumRange));
        }
        ...
        {
            return _modifications[829186629, level].ValueAsFloat;
        }
        ...
        {
            return _modifications[845963845, level].ValueAsFloat;
        }
