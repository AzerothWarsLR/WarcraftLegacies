...
namespace War3Api.Object.Abilities
{
    public sealed class AttackBonus_AItc : Ability
    {
        ...
        public AttackBonus_AItc(ObjectDatabase db): base(1668565313, db)
        {
            _dataAttackBonus = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataAttackBonus, SetDataAttackBonus));
        }

        public AttackBonus_AItc(int newId, ObjectDatabase db): base(1668565313, newId, db)
        {
            _dataAttackBonus = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataAttackBonus, SetDataAttackBonus));
        }

        public AttackBonus_AItc(string newRawcode, ObjectDatabase db): base(1668565313, newRawcode, db)
        {
            _dataAttackBonus = new Lazy<ObjectProperty<int>>(() => new ObjectProperty<int>(GetDataAttackBonus, SetDataAttackBonus));
        }
