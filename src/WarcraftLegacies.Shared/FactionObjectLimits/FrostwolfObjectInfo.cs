...
public static class FrostwolfObjectInfo
{
  ...
  public static IEnumerable<ObjectInfo> GetAllObjectLimits()
  {
    ...
    yield return new(UNIT_OTTO_TAUREN_TOTEM_FROSTWOLF_SIEGE, Unlimited, UnitCategory.SiegeWorkshop);
    ...
    yield return new(UNIT_O002_IMPROVED_WATCH_TOWER_FROSTWOLF_TOWER_2, Unlimited, UnitCategory.Tower);
    ...
    yield return new(UNIT_OGRU_GRUNT_FROSTWOLF, Unlimited, UnitCategory.Fighter);
    yield return new(UNIT_OTAU_TAUREN_FROSTWOLF, Unlimited, UnitCategory.Fighter);
    yield return new(UNIT_OHUN_HEADHUNTER_FROSTWOLF, Unlimited, UnitCategory.Marksman);
    yield return new(UNIT_OCAT_CATAPULT_FROSTWOLF, 6, UnitCategory.Siege);
    yield return new(UNIT_OTBR_BATRIDER_FROSTWOLF, 12, UnitCategory.Flyer);
    yield return new(UNIT_ODOC_WITCH_DOCTOR_FROSTWOLF, Unlimited, UnitCategory.Support);
    yield return new(UNIT_OSHM_SHAMAN_FROSTWOLF, Unlimited, UnitCategory.Support);
    yield return new(UNIT_OSPW_SPIRIT_WALKER_FROSTWOLF, Unlimited, UnitCategory.Support);
