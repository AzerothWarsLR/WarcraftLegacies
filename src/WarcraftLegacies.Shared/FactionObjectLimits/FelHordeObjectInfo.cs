...
public static class FelHordeObjectInfo
{
  ...
  {
    yield return new(UNIT_O02Y_GREAT_HALL_FEL_T1, Unlimited);
    yield return new(UNIT_O02Z_STRONGHOLD_FEL_T2, Unlimited);
    yield return new(UNIT_O030_FORTRESS_FEL_T3, Unlimited);
    yield return new(UNIT_O02V_ALTAR_OF_DOMINATION_FEL_ALTAR, Unlimited);
    yield return new(UNIT_O02W_BARRACKS_FEL_BARRACKS, Unlimited);
    yield return new(UNIT_O031_WAR_MILL_FEL_RESEARCH, Unlimited);
    yield return new(UNIT_O033_DARK_ENCLAVE_FEL_MAGIC, Unlimited);
    yield return new(UNIT_O02X_BEASTIARY_FEL_SPECIALIST, Unlimited);
    yield return new(UNIT_O032_SHIPYARD_FEL_SHIPYARD, Unlimited, UnitCategory.Shipyard);
    yield return new(UNIT_O034_WATCH_TOWER_FEL_TOWER, Unlimited);
    yield return new(UNIT_O035_IMPROVED_WATCH_TOWER_FEL_TOWER_2, Unlimited);
    yield return new(UNIT_U00Q_TREASURY_FEL_SHOP, Unlimited);
    yield return new(UNIT_N0AM_FLAME_PILLAR_FEL_TOWER, Unlimited);
    yield return new(UNIT_N0AN_IMPROVED_FLAME_PILLAR_FEL_TOWER_2, Unlimited);
    yield return new(UNIT_OCBW_FEL_BURROW_FEL_FARM, Unlimited);
    yield return new(UNIT_N0AP_FOCAL_DEMON_GATE_FEL_SIEGE, Unlimited);
    yield return new(UNIT_NBDK_OBSIDIAN_DRAKE_FEL, 6);
    yield return new(UNIT_ODKT_EREDAR_OCCULTIST_FEL, 6);
    yield return new(UNIT_NCHW_FEL_WARLOCK_FEL, Unlimited);
    yield return new(UNIT_NCHG_FEL_GRUNT_FEL, Unlimited);
    yield return new(UNIT_NCHR_FEL_RAIDER_FEL, Unlimited);
    yield return new(UNIT_NCPN_FEL_PEON_FEL_WORKER, Unlimited);
    yield return new(UNIT_OWAR_BONEBREAKER_FEL, 12);
    yield return new(UNIT_O01L_EXECUTIONER_FEL_ELITE, 6);
    yield return new(UNIT_O01O_DEMOLISHER_FEL, 8);
    yield return new(UNIT_U018_EYE_OF_GRILLOK_FEL, 10);
    yield return new(UNIT_U00V_NECROLYTE_FEL, Unlimited);
    yield return new(UNIT_N058_FEL_CROSSBOWMAN_FEL, Unlimited);
    yield return new(UNIT_NINA_INFERNAL_JUGGERNAUT_FEL, 4);
    yield return new(UNIT_N086_FEL_DEATH_KNIGHT_FEL_ELITE_TIER, 6);
    ...
    yield return new(UNIT_N05T_KAZZAK_THE_SUPREME_FEL_DEMI, 1);
    yield return new(UNIT_N08A_FOUNDRY_SKYWALL_BARRACKS, 1);
    yield return new(UNIT_N03D_WARCHIEF_OF_THE_FEL_HORDE_FEL, 1);
    yield return new(UNIT_NBBC_WARCHIEF_OF_THE_BLACKROCK_CLAN_FEL, 1);
    yield return new(UNIT_U02D_DEATH_KNIGHT_LORD_FEL_HORDE, 1);
    yield return new(UNIT_NMAG_LORD_OF_OUTLAND_FEL, 1);
