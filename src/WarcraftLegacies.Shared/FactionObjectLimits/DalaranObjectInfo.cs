...
public static class DalaranObjectInfo
{
  ...
  public static IEnumerable<ObjectInfo> GetAllObjectLimits()
  {
    ...
    yield return new(UNIT_H079_ARCANE_TOWER_DALARAN_TOWER, Unlimited, UnitCategory.Tower); //Arcane Tower
    yield return new(UNIT_H07A_IMPROVED_ARCANE_TOWER_DALARAN_TOWER, Unlimited, UnitCategory.Tower); //Arcane Tower (Improved)
    yield return new(UNIT_NDGT_KIRIN_TOR_TOWER_DALARAN_TOWER, Unlimited, UnitCategory.Tower); //Dalaran Tower
    yield return new(UNIT_N004_IMPROVED_KIRIN_TOR_TOWER_DALARAN_TOWER, Unlimited, UnitCategory.Tower); //Dalaran Tower (Improved)
    ...
    yield return new(UNIT_NHYM_HYDROMANCER_DALARAN, Unlimited, UnitCategory.Support); //Hydromancer
    yield return new(UNIT_H032_BATTLEMAGE_DALARAN, Unlimited, UnitCategory.Fighter); //Battlemage
    yield return new(UNIT_H02D_GEOMANCER_DALARAN, Unlimited, UnitCategory.Support); //Geomancer
    yield return new(UNIT_H01I_ARCANIST_DALARAN, Unlimited, UnitCategory.Support); //Arcanist
    yield return new(UNIT_N007_KIRIN_TOR_DALARAN_ELITE, 6, UnitCategory.Elite); //Kirin Tor
    yield return new(UNIT_N096_EARTH_GOLEM_DALARAN, 6, UnitCategory.Fighter); //Earth Golem
    yield return new(UNIT_N0AK_INITIATE_MAGE_DALARAN, Unlimited, UnitCategory.Marksman); //Initiate Mage
