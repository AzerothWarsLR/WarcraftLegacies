...
public static class SentinelsObjectInfo
{
  ...
  public static IEnumerable<ObjectInfo> GetAllObjectLimits()
  {
    ...
    yield return new(UNIT_E00R_ALTAR_OF_WATCHERS_SENTINEL_ALTAR, Unlimited);
    yield return new(UNIT_E00L_WAR_ACADEMY_SENTINEL_BARRACKS, Unlimited);
    yield return new(UNIT_EDOB_HUNTER_S_HALL_SENTINEL_RESEARCH, Unlimited);
    yield return new(UNIT_EDEN_DEN_OF_WONDERS_SENTINEL_SHOP, Unlimited);
    yield return new(UNIT_E011_KALDOREI_DOCKS_SENTINEL_SHIPYARD, Unlimited, UnitCategory.Shipyard);
    yield return new(UNIT_H03N_IMPROVED_HUNTER_TOWER_SENTINEL_TOWER, Unlimited);
    yield return new(UNIT_H03M_HUNTER_TOWER_SENTINEL_TOWER, Unlimited);
    yield return new(UNIT_N06O_SENTINEL_EMBASSY_SENTINEL_T2, Unlimited);
    yield return new(UNIT_N06P_SENTINEL_ENCLAVE_SENTINEL_T3, Unlimited);
    yield return new(UNIT_N06J_SENTINEL_OUTPOST_SENTINEL_T1, Unlimited, UnitCategory.TownHall);
    yield return new(UNIT_N06M_RESIDENCE_SENTINEL_DRUID_FARM, Unlimited);
    yield return new(UNIT_EDOS_ROOST_SENTINEL_SPECIALIST, Unlimited);
    yield return new(UNIT_E00T_WATCHER_S_BASTION_SENTINEL_SIEGE, Unlimited);
    ...
    yield return new(UNIT_H08V_GLAIVE_MAIDEN_SENTINEL, Unlimited);
    ...
    yield return new(1853317492, Unlimited); // Sentry
