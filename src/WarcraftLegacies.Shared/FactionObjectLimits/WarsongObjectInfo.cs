...
public static class WarsongObjectInfo
{
  ...
  public static IEnumerable<ObjectInfo> GetAllObjectLimits()
  {
    ...
    yield return new(UNIT_O05G_SIEGE_WORKSHOP_WARSONG_SIEGE, Unlimited, UnitCategory.SiegeWorkshop);
    ...
    yield return new(UNIT_N0AL_IMPROVED_IRON_KEEP_WARSONG_TOWER_2, Unlimited, UnitCategory.Tower);
    ...
    yield return new(UNIT_O00G_BLADEMASTER_WARSONG, 6, new List<UnitCategory> { UnitCategory.Fighter, UnitCategory.Assassin });
    yield return new(UNIT_N03F_KOR_KRON_ELITE_WARSONG_ELITE, 6, new List<UnitCategory> { UnitCategory.Elite, UnitCategory.Fighter, UnitCategory.Destroyer, UnitCategory.Summoner });
    ...
    yield return new(UNIT_O06L_WARLORD_OF_THE_WARSONG_CLAN_WARSONG, 1, UnitCategory.Fighter); //garrosh?
    yield return new(UNIT_OGRH_CHIEFTAIN_OF_THE_WARSONG_CLAN_WARSONG, 1, UnitCategory.Fighter); //grom
    yield return new(UNIT_O005_WARSONG_BATTLEMASTER_WARSONG, 1, new List<UnitCategory> { UnitCategory.Fighter, UnitCategory.Summoner }); //IDK?
