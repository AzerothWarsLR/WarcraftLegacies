...
public static class LordaeronObjectInfo
{
  ...
  public static IEnumerable<ObjectInfo> GetAllObjectLimits()
  {
    ...
    yield return new(UNIT_HBAR_BARRACKS_LORDAERON_BARRACKS, Unlimited, Barracks);
    yield return new(UNIT_HBLA_BLACKSMITH_LORDAERON_RESEARCH, Unlimited, Research);
    yield return new(UNIT_H035_ARCANE_STUDY_LORDAERON_MAGIC, Unlimited, Magic);
    yield return new(UNIT_HWTW_SCOUT_TOWER_LORDAERON_TOWER, Unlimited, Tower);
    yield return new(UNIT_HGTW_GUARD_TOWER_LORDAERON_TOWER, Unlimited, Tower);
    yield return new(UNIT_H006_IMPROVED_GUARD_TOWER_LORDAERON_TOWER, Unlimited, Tower);
    yield return new(UNIT_HCTW_CANNON_TOWER_LORDAERON_TOWER, Unlimited, Tower);
    yield return new(UNIT_H007_IMPROVED_CANNON_TOWER_LORDAERON_TOWER, Unlimited, Tower);
    yield return new(UNIT_HSHY_SHIPYARD_LORDAERON_SHIPYARD, Unlimited, Shipyard);
    yield return new(UNIT_NMRK_MARKETPLACE_LORDAERON_SHOP, Unlimited, Shop);
    ...
    yield return new(UNIT_NWE2_THUNDER_EAGLE_LORDAERON, 6, new List<UnitCategory> { Flyer, Marksman });
    yield return new(UNIT_H01C_HUNTSMAN_LORDAERON, Unlimited, Marksman);
    yield return new(UNIT_N03K_PASTOR_LORDAERON, Unlimited, Support);
    yield return new(UNIT_HCTH_SILVER_HAND_SQUIRE_LORDAERON, 12, Fighter);
    yield return new(UNIT_H02Q_PEGASUS_KNIGHT_LORDAERON, 6, new List<UnitCategory> { Flyer, Fighter, Support });
    yield return new(UNIT_E017_SCORPION_LORDAERON, 8, Marksman);
    yield return new(UNIT_O02F_MANGONEL_LORDAERON, 6, Siege);
    yield return new(UNIT_H09Y_THRONE_GUARD_LORDAERON, 2, new List<UnitCategory> { Fighter, Support });
    ...
    yield return new(UNIT_HLGR_GRAND_MARSHAL_SCARLET, 1, new List<UnitCategory> { Tank, Support });
    yield return new(UNIT_HARF_HIGH_KING_LORDAERON_HIGH_KING, 1, new List<UnitCategory> { Destroyer, Support });
