...
public static class OrcishHordeObjectInfo
{
  ...
  public static IEnumerable<ObjectInfo> GetAllObjectLimits()
  {
    ...
    yield return new(UNIT_O077_STRONGHOLD_ORCISH_HORDE_T2, Unlimited, Keep);
    yield return new(UNIT_O07G_FORTRESS_ORCISH_HORDE_T3, Unlimited, Castle);
    ...
    yield return new(UNIT_O07H_WAR_MILL_ORCISH_HORDE_RESEARCH, Unlimited, Research);
