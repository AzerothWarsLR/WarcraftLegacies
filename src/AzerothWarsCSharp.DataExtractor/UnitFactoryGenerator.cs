...
namespace AzerothWarsCSharp.DataExtractor
{
  public class UnitFactoryGenerator
  {
    private static readonly Dictionary<int, PropertyMetadata> _idToPropertyMetadata = new()
    {
      ...
      { 1919903605, new PropertyMetadata("RepairGoldCost", PropertyValueType.Int) },
      ...
      { 1953980789, new PropertyMetadata("AwakenTooltip", PropertyValueType.String) },
      { 1919972469, new PropertyMetadata("ReviveTooltip", PropertyValueType.String) },
      ...
      { 1667330677, new PropertyMetadata("Race", PropertyValueType.String) },
      ...
      { 1853186933, new PropertyMetadata("CasterUpgradeNames", PropertyValueType.String) },
      { 1953850229, new PropertyMetadata("CasterUpgradeTooltip", PropertyValueType.String) },
      ...
      { 1768186485, new PropertyMetadata("BountyDice", PropertyValueType.Int) },
      { 1633837685, new PropertyMetadata("BountyPlus", PropertyValueType.Int) },
      { 1769169525, new PropertyMetadata("BountySides", PropertyValueType.Int) },
      ...
      { 1920298101, new PropertyMetadata("LumberRepairCost", PropertyValueType.Int) },
