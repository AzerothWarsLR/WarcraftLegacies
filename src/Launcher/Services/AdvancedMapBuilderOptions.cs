...
public sealed class AdvancedMapBuilderOptions
{
  ...
  public static AdvancedMapBuilderOptions Create(string mapName)
  {
    ...
    return Create(sharedPathOptions);
  }

  /// <summary>
  /// Path to the file or folder in which to write the fully built map.
  /// </summary>
  public required string W3XFolderPath { get; set; }

  /// <summary>
  /// Path to the file in which to write a ready-to-release published map.
  /// </summary>
  public required string PublishedMapPath { get; set; }
