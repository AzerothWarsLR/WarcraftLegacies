...
public sealed class AdvancedMapBuilder(AdvancedMapBuilderOptions options)
{
  ...
  private void ApplyMigrations(Map map)
  {
    ...
    foreach (var migration in options.MapMigrations)
    {
  ...
  private static void LaunchGame(string warcraft3ExecutablePath, string mapFilePath)
  {
    ...
    else
    {
      throw new InvalidOperationException(
        "Please set Warcraft3ExecutablePath in WarcraftLegacies.CLI/appsettings.json to the path of your Warcraft III executable.");
    }
  }
}
