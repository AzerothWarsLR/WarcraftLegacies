...
namespace WarcraftLegacies.Source.Setup
{
  public static class GateSetup
  {
    public static void Setup()
    {
      ...
      PassiveAbilityManager.Register(new Gate(Constants.UNIT_H04R_DIAGONAL_WOODEN_GATE_OPEN,
        Constants.UNIT_H04S_DIAGONAL_WOODEN_GATE_CLOSED, Constants.UNIT_H04T_DIAGONAL_WOODEN_GATE_DEAD));
    }
  }
}