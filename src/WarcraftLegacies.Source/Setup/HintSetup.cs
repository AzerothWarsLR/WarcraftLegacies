...
namespace WarcraftLegacies.Source.Setup
{
  public static class HintConfig
  {
    public static void Setup()
    {
      ...
      Hint.Register("When a player leaves, their units are funded, then their gold and hero experience are spread among their remaining allies.");
      ...
      Hint.Register($"Each turn, every Capital and every gate gains bonus maximum hit points. Capitals gain {CapitalManager.HitPointPercentagePerTurn*100}% and gates gain {MacroTools.PassiveAbilities.Gate.HitPointPercentagePerTurn*100}%.");
