...
{
  /// <summary>
  /// Responsible for registering all <see cref="IncompatibleResearchSystem"/>s.
  /// </summary>
  public static class IncompatibleResearchSetup
  {
    /// <summary>
    /// Registers all <see cref="IncompatibleResearchSystem"/>s.
    /// </summary>
    public static void Setup()
    {
      IncompatibleResearchSystem.Register(Constants.UPGRADE_R02Y_BATTLE_TACTICS_ARATHOR_T1,
        Constants.UPGRADE_R03D_VETERAN_GUARD_ARATHOR_T1);

      IncompatibleResearchSystem.Register(Constants.UPGRADE_R03T_ELECTRIC_STRIKE_RITUAL_ARATHOR_T1,
        Constants.UPGRADE_R03U_SOLAR_FLARE_RITUAL_ARATHOR_T1);

      IncompatibleResearchSystem.Register(Constants.UPGRADE_R03B_EXPLOIT_WEAKNESS_ARATHOR_T2,
        Constants.UPGRADE_R02Z_REFLECTIVE_PLATING_ARATHOR_T2);

      IncompatibleResearchSystem.Register(Constants.UPGRADE_R03V_MAGES_OF_STROMGARDE_ARATHOR_T2,
