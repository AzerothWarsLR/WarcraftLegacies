...
namespace WarcraftLegacies.Source.Setup.Spells
{
  public static class GoblinSpellSetup
  {
    public static void Setup()
    {
      ...
      PassiveAbilityManager.Register(new Trader(Constants.UNIT_NZEP_TRADING_ZEPPELIN_WARSONG, 15, zeppelinTradeTargets));
      ...
      PassiveAbilityManager.Register(new Trader(Constants.UNIT_O04S_TRADER_GOBLIN, 25, traderTradeTargets));
