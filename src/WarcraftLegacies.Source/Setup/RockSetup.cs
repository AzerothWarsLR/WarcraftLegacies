...
namespace WarcraftLegacies.Source.Setup
{
  ...
  public static class RockSetup
  {
    ...
    public static void Setup()
    {
      ...
      RockSystem.Register(new RockGroup(Regions.KaliRock9, RockChunkId, 600));
      ...
      RockSystem.Register(new RockGroup(Regions.KaliRock7, ForestChunkId, 600));
      RockSystem.Register(new RockGroup(Regions.KaliRock10, ForestChunkId, 600));
      RockSystem.Register(new RockGroup(Regions.KaliRock11, ForestChunkId, 600));
    }
  }
}