...
namespace WarcraftLegacies.Source.Factions.Zandalar.Quests;
  ...
  {
    private const int _zulgurubResearch = UPGRADE_MD36_QUEST_COMPLETED_HEART_OF_HAKKAR; //Add research for quest
    ...
    public QuestZulgurub (Capital Zulgurub): base("Heart of Hakkar",
        ...
        @"ReplaceableTextures\CommandButtons\BTNTrollRavager.blp")
      {
        ...
        ResearchId = UPGRADE_MD36_QUEST_COMPLETED_HEART_OF_HAKKAR;
        goldReward = 250;
    }
