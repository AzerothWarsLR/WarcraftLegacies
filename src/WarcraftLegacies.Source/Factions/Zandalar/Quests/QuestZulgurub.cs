...
namespace WarcraftLegacies.Source.Factions.Zandalar.Quests;
{
  ...
  {
    private const int _zulgurubResearch = UPGRADE_R02M_QUEST_COMPLETED_THE_HEART_OF_HAKKAR_WARSONG; //Add research for quest
    private const int _trollShrineId = UNIT_O04X_LOA_SHRINE_ZANDALARI_SIEGE; // add the shrine for the new unit
    private const int _ravagerId = UNIT_O021_RAVAGER_ZANDALAR; //make the unit
