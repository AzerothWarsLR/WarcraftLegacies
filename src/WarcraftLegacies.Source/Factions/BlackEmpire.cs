...
namespace WarcraftLegacies.Source.Factions
{
  public class BlackEmpire : Faction
  {
    ...
    private void RegisterObjectLimits()
    {
      ...
      ModObjectLimit(UPGRADE_RBEP_PARALYSING_FEAR_BLACK_EMPIRE, UNLIMITED);
      ModObjectLimit(UPGRADE_RBEV_SHADOW_VEIL_BLACK_EMPIRE, UNLIMITED);
      ModObjectLimit(UPGRADE_RBEA_ACCELERATED_CYCLE_BLACK_EMPIRE_STYGIAN_HULK, UNLIMITED);
      ModObjectLimit(UPGRADE_RBFC_CURSED_FLESH_BLACK_EMPIRE_STYGIAN_HULK, UNLIMITED);
