  ...
  public class BlackEmpire : Faction
  {
    ...
    private void RegisterObjectLimits()
    {
     ...
     // All Nzoth Ships
      ...
      ModObjectLimit(Constants.UNIT_U00P_LIEUTENANT_OF_N_ZOTH, 1);
      ModObjectLimit(Constants.UNIT_U02B_N_RAQI_ABERRATION, 1);
      ModObjectLimit(Constants.UNIT_E01D_MOUTH_OF_N_ZOTH_YOGG, 1);
