...
/// </summary>
public static class ScourgeSpells
{
  /// <summary>
  ...
  public static void Setup()
  {
    ...
    SpellRegistry.Register(new CorruptionMineSpell(ABILITY_A14S_CORRUPTION_MINE_RIVENDARE)
    {
      ...
      CorruptionBuffApplicatorId = ABILITY_A14V_CORRUPTION_MINE_BUFF_APPLICATOR_BUFF_APPLICATOR,
      CorruptionBuffId = BUFF_B0DW_CORRUPTION,
      CorruptionDuration = 8,
