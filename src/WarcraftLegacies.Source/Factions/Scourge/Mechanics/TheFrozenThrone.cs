...
public static class TheFrozenThrone
{
  ...
  public static void Setup(ScourgeFaction scourge, Capital frozenThrone, LegendaryHero lichKing)
  {
  ...
  {
    if (!FactionManager.TryGetFactionByType<ScourgeFaction>(out var scourge))
    {
      return;
    }
