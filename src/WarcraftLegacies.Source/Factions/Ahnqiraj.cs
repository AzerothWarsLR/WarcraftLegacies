...
namespace WarcraftLegacies.Source.Factions
{
  public class Ahnqiraj : Faction
  {
    ...
    {
      ModObjectLimit(UNIT_U020_MONUMENT_C_THUN_BUILDING, UNLIMITED);
      ModObjectLimit(UNIT_U021_RUINED_TEMPLE_C_THUN_BUILDING, UNLIMITED);
      ModObjectLimit(UNIT_U022_NEXUS_C_THUN_BUILDING, UNLIMITED);
      ModObjectLimit(UNIT_N071_PILLAR_OF_C_THUN_C_THUN_PILLARS, UNLIMITED);
      ModObjectLimit(UNIT_U01G_SPIRIT_HALL_C_THUN_BUILDING, UNLIMITED);
      ModObjectLimit(UNIT_O00R_HATCHERY_C_THUN_BUILDING, UNLIMITED);
      ModObjectLimit(UNIT_O00D_PYRAMID_C_THUN_BUILDING, UNLIMITED);
      ModObjectLimit(UNIT_U01H_ANCIENT_CATACOMBS_C_THUN_BUILDING, UNLIMITED);
      ModObjectLimit(UNIT_U01I_CHAMBER_OF_WONDERS_C_THUN_BUILDING_ITEM, UNLIMITED);
      ModObjectLimit(UNIT_U01F_ALTAR_OF_THE_OLD_ONES_C_THUN_BUILDING, UNLIMITED);


      ModObjectLimit(UNIT_U019_DRONE_C_THUN_WORKER, UNLIMITED);
      ModObjectLimit(UNIT_O000_SILITHID_COLOSSUS_C_THUN_ELITES, 6);
      ...
      ModObjectLimit(UNIT_U013_GIANT_SCARAB_C_THUN_GIANT_SCARAB, UNLIMITED);
      ...
      ModObjectLimit(UNIT_H01K_SILITHID_OVERLORD_C_THUN_OVERLORD, 12);
