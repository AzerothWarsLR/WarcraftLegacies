...
namespace WarcraftLegacies.Source.Factions.Quelthalas.Researches;
...
{
  /// <inheritdoc />
  public SunfuryWarrior(int researchTypeId, int goldCost, int lumberCost = 0) : base(researchTypeId, goldCost, lumberCost)
  {
  }
