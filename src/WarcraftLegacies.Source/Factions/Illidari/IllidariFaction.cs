...
public sealed class IllidariFaction : Faction
{
  /// <inheritdoc />
  public IllidariFaction() : base("Illidan", playercolor.Violet,
    @"ReplaceableTextures\CommandButtons\BTNEvilIllidan.blp")
  {
    ...
    RegisterFactionDependentInitializer<SentinelsFaction>(RegisterSentinelsDialogue);
  ...
  private void RegisterSentinelsDialogue(SentinelsFaction sentinels)
  {
  ...
  private void RegisterSentinelsDruidsDialogue(SentinelsFaction sentinels, DruidsFaction druids)
  {
    TriggeredDialogueManager.Add(
      new TriggeredDialogue(new DialogueSequence(new Dialogue(
  ...
  private void RegisterFelHordeQuests(FelHordeFaction felHordeFaction)
  {
    ...
    questBurningCrusade.AddObjective(new ObjectiveFactionQuestComplete(felHordeFaction.GetQuestByType<QuestDarkPortal>(), felHordeFaction)
    {
      ShowsInPopups = false,
      ShowsInQuestLog = false,
      Progress = QuestProgress.Undiscovered
  ...
  private void RegisterSentinelsQuests(SentinelsFaction sentinels)
  {
