...
public sealed class FlightPath : Research
{
  ...
  public override void OnResearch(player researchingPlayer)
  {
    ...
    _horde.SetObjectLevel(ResearchId, 1);
    _researched = true;
  }
