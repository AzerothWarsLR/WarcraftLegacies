...
public sealed class QuestFreeNerzhul : QuestData
{
  ...
  public QuestFreeNerzhul(Capital theFrozenThrone, LegendaryHero thrall, QuestData warsongHold, QuestData kalimdorAblaze) : base("Jailor of the Damned",
    ...
    @"ReplaceableTextures\CommandButtons\BTNLichKing.blp")
  {
    _thrall = thrall;
    ...
    AddObjective(new ObjectiveAnyQuestComplete(warsongHold, kalimdorAblaze)
    {
