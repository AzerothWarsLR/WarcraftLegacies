...
public sealed class QuestSubdueTauren : QuestData
{
  ...
  public QuestSubdueTauren(Rectangle rescueRect, WarsongLegends warsongLegends, LegendaryHero grom)
    : base(
      "Unyielding Bonds",
      ...
      @"ReplaceableTextures\CommandButtons\BTNTauren.blp")
  {
    ...
    AddObjective(new ObjectiveControlLegend(warsongLegends.GromHellscream, true));
