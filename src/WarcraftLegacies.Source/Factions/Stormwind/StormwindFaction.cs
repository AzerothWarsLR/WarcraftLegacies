...
using WarcraftLegacies.Source.Factions.Stormwind.Researches;
...
public sealed class StormwindFaction : Faction
{
  /// <inheritdoc />
  public StormwindFaction() : base("Stormwind", playercolor.Blue,
