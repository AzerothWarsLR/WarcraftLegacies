...
namespace WarcraftLegacies.Source.Quests.Warsong
{
  public sealed class QuestGarrosh : QuestData
  {
    ...
    /// <inheritdoc/>
    protected override string RewardDescription => $"Can now train Garrosh from the {GetObjectName(UNIT_O020_ALTAR_OF_CONQUERORS_WARSONG_ALTAR)} and research the Warsong expedition from the {GetObjectName(UNIT_O009_REFINERY_WARSONG_RESEARCH)}";
