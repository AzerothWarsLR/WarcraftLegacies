...
namespace WarcraftLegacies.Source.Quests.Lordaeron
{
  ...
  public sealed class QuestKingdomOfManLordaeron : QuestData
  {
        ...
        @"ReplaceableTextures\CommandButtons\BTNFireKingCrown.blp")
    {
      ...
      AddObjective(new ObjectiveControlPoint(UNIT_N010_STORMWIND_CITY, 0));
      AddObjective(new ObjectiveControlPoint(UNIT_N01G_LORDAERON_CITY, 0));
      Global = true;
    }
    ...
    protected override void OnComplete(Faction completingFaction)
    {
      ...
      if (_arthas.Unit != null) 
        AddHeroXP(_arthas.Unit, CompletionExperienceBonus, true);
