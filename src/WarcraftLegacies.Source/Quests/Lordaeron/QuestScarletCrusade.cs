  ...
  public sealed class QuestScarletCrusade : QuestData
  {
    ...
    public QuestScarletCrusade(Rectangle rescueRect, Capital tyrsHand, LegendaryHero saiden, Faction scarletCrusade) :
      base("The Scarlet Crusade",
        "Lordaeron is destined to fall to the Scourge. Should such an event come to pass, the Silver Hand will become transformed beyond recognition, abandoning ideals of justice in favour of those of vengeance.",
