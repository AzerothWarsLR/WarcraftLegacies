...
namespace WarcraftLegacies.Source.Quests.Frostwolf
{
  ...
  public sealed class QuestSeaWitch : QuestData
  {
      ...
      "ReplaceableTextures\\CommandButtons\\BTNGhost.blp")
    {
      ...
      _rescueEchoUnits = rescueRect.PrepareUnitsForRescue(Player(PLAYER_NEUTRAL_PASSIVE),true,true);
      _rescueDarkspearUnits = Regions.Thrall_Landing1.PrepareUnitsForRescue(Player(PLAYER_NEUTRAL_PASSIVE),true);
