...
namespace WarcraftLegacies.Source.Quests.Sunfury
{
  ...
  public sealed class QuestTempestKeep : QuestData
  {
    ...
    protected override string RewardDescription =>
      $"Gain control of Tempest Keep, and learn to build {GetObjectName(Constants.UNIT_H0CA_VOID_WELL_SUNFURY_SPECIALIST)}s and {GetObjectName(Constants.UNIT_H0CI_TEMPEST_FORGE_SUNFURY_SPECIALIST)}s";
  }
}