...
{ 
  ...
  public sealed class QuestMawofGorma : QuestData
  {
    ...
    /// <inheritdoc />
    protected override string RewardDescription => $"Control of all buildings in the Maw of Gor'ma area and the ability to train Learn to train 1 {GetObjectName(UNIT_U02F_FORGOTTEN_ONE_YOGG)}";
