...
namespace WarcraftLegacies.Source.Quests.Goblin
{
  ...
  public sealed class QuestRatchet : QuestData
  {
    ...
    /// <inheritdoc />
    protected override string RewardFlavour => "We have succesfully established a port at Ratchet!";

    /// <inheritdoc />
    protected override string RewardDescription => "You have unlocked Ratchet.";
