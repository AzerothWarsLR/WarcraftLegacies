...
namespace WarcraftLegacies.Source.Quests.Legion
{
  public sealed class QuestControlShadowfang : QuestData
  {
    ...
    /// <inheritdoc/>
    protected override string RewardDescription => "Unlock Shadowfang Keep as a troop production building and 500 gold. Completing any of the three infiltration quest will enable the Alterac Portal to be opened.";
