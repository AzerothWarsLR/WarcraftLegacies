...
namespace WarcraftLegacies.Source.Quests.Quelthalas
{
  ...
  public sealed class QuestForgottenKnowledge : QuestData
  {
    ...
    protected override string RewardDescription =>
      $"Learn to train {GetObjectName(Constants.UNIT_E01B_ARCANE_ANNIHILATOR_QUEL_THALAS)}s from the {GetObjectName(Constants.UNIT_H0CI_TEMPEST_FORGE_SUNFURY_SPECIALIST)}";
  }
}