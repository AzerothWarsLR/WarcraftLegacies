...
namespace WarcraftLegacies.Source.Quests.Quelthalas
{
  ...
  public sealed class QuestSilvermoon : QuestData
  {
    ...
    protected override string RewardDescription =>
      "Control of all units in Silvermoon, unlocked the Summon Mystic Defenders ability from Elven Runestones and enable Anasterian to be trained at the Altar";
