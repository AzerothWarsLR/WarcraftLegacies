...
/// </summary>
public sealed class ObjectiveAnyUnitReachRect : Objective, IHasCompletingUnit
{
  private readonly bool _heroOnly;
  private readonly rect _targetRect;

  /// <summary>
  /// Initializes a new instance of the <see cref="ObjectiveAnyUnitReachRect"/> class.
  /// </summary>
  ...
  public ObjectiveAnyUnitReachRect(Rectangle targetRect, string rectName, bool heroOnly)
  {
    ...
    Description = heroOnly ? $"You have a hero reach {rectName}" : $"You have a unit reach {rectName}";
    _heroOnly = heroOnly;
