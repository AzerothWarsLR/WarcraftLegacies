...
public static class TierVeteranGuard
{
  ...
  {
    GetTriggerPlayer().GetFaction()?.ModObjectLimit(UNIT_H03K_MARSHAL_STORMWIND, -Faction.Unlimited);
    GetTriggerPlayer().GetFaction()?.ModObjectLimit(UNIT_H03U_REAR_MARSHAL_STORMWIND_DEFENSIVE, 12);
  }
