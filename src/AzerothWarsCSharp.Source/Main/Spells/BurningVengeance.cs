...
namespace AzerothWarsCSharp.Source.Main.Spells
{
  public class BurningVengeance{
    ...
    private const int HERO_ID = FourCC(O04H) ;//The hero that can use Take Vengeance

    private const int ABIL_ID = FourCC(A0OO);
    private const int ALTERNATE_FORM_ID = FourCC(e01A);
