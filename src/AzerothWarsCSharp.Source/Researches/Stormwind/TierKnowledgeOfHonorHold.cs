...
{
  public class TierKnowledgeOfHonorHold{
    ...
    private static void EnablePortals( ){
      ...
      WaygateSetDestination(waygateA, GetPolarOffsetY(GetUnitX(waygateB), WAYGATE_OFFSET, GetUnitFacing(waygateB)), GetPolarOffsetY(GetUnitY(waygateB), WAYGATE_OFFSET, GetUnitFacing(waygateB)));
