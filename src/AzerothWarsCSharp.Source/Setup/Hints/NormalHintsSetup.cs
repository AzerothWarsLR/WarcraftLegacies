...
{
  public static class NormalHintsSetup
  {
    public static void Initialize()
    {
      Hint.Register(new Hint("If your ally leaves the game, you get a bonus to all of your units. If you form another alliance, you'll lose that bonus."));
      ...
      Hint.Register(new Hint("You can ally and unally other players using commands. Type -ally to find out more."));
      ...
      Hint.Register(new Hint("You can type -unally to unally everyone on your team."));
    }
  }
}
