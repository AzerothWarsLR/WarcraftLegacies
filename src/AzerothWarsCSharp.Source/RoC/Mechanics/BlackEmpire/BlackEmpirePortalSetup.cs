...
namespace AzerothWarsCSharp.Source.RoC.Mechanics.BlackEmpire
{
  public class BlackEmpirePortalSetup{
    ...
    public static void Setup( ){
      ...
      BLACKEMPIREPORTAL_TANARIS.NearbyControlPoint = ControlPoint.ByUnitType(FourCC(n0BD));
      ...
      BLACKEMPIREPORTAL_NORTHREND.NearbyControlPoint = ControlPoint.ByUnitType(FourCC(n02S));
