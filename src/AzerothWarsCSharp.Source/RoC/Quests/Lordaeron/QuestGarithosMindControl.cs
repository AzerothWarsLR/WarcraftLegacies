...
namespace AzerothWarsCSharp.Source.RoC.Quests.Lordaeron
{
  public class QuestGarithosMindControl{
    ...
    private void OnComplete( ){
      ...
      CreateUnits(this.Holder.Player, FourCC(hkni), GetRectCenterX(gg_rct_Terenas), GetRectCenterY(gg_rct_Terenas), 270, 12);
      CreateUnits(this.Holder.Player, FourCC(hpea), GetRectCenterX(gg_rct_Terenas), GetRectCenterY(gg_rct_Terenas), 270, 6);
      CreateUnits(this.Holder.Player, FourCC(hfoo), GetRectCenterX(gg_rct_Terenas), GetRectCenterY(gg_rct_Terenas), 270, 12);
      CreateUnits(this.Holder.Player, FourCC(h009), GetRectCenterX(gg_rct_Terenas), GetRectCenterY(gg_rct_Terenas), 270, 2);
