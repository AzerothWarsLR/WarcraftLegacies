...
namespace AzerothWarsCSharp.Source.RoC.Quests.Legion
{
  public class QuestDreadlordInsurgent{
    ...
    private void OnComplete( ){
      ...
      CreateUnits(this.Holder.Player, FourCC(n04J), GetRectCenterX(gg_rct_Vandermar_Village), GetRectCenterY(gg_rct_Vandermar_Village), 270, 12);
      CreateUnits(this.Holder.Player, FourCC(u00D), GetRectCenterX(gg_rct_Vandermar_Village), GetRectCenterY(gg_rct_Vandermar_Village), 270, 6);
      CreateUnits(this.Holder.Player, FourCC(ninc), GetRectCenterX(gg_rct_Vandermar_Village), GetRectCenterY(gg_rct_Vandermar_Village), 270, 12);
      CreateUnits(this.Holder.Player, FourCC(u007), GetRectCenterX(gg_rct_Vandermar_Village), GetRectCenterY(gg_rct_Vandermar_Village), 270, 2);
