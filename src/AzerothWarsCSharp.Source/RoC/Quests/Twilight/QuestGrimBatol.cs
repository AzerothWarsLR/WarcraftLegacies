...
namespace AzerothWarsCSharp.Source.RoC.Quests.Twilight
{
  public class QuestGrimBatol{
    ...
    private void OnFail( ){
      RescueNeutralUnitsInRect(gg_rct_Grim_Batol, Player(PLAYER_NEUTRAL_AGGRESSIVE));
    }
    ...
    protected override void OnComplete(){
      ...
      RescueNeutralUnitsInRect(gg_rct_Grim_Batol, this.Holder.Player);
    }
    ...
    public  thistype ( ){
      ...
      this.AddQuestItem(QuestItemControlPoint.create(ControlPoint.ByUnitType(FourCC(n03X))));
      this.AddQuestItem(QuestItemControlPoint.create(ControlPoint.ByUnitType(FourCC(n04V))));
      this.AddQuestItem(QuestItemControlPoint.create(ControlPoint.ByUnitType(FourCC(n09F))));
