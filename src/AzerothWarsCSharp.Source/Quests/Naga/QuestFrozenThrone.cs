...
namespace AzerothWarsCSharp.Source.Quests.Naga
{
  public sealed class QuestFrozenThrone : QuestData
  {
    ...
    public QuestFrozenThrone()
    {
      thistype this = thistype.allocate("A Symphony of Frost && Flame",
        "Kil'jaeden has ordered Illidan to destroy the Frozen Throne, && he shall obey.",
    ...
    protected override void OnComplete()
    {
      ...
      if (FACTION_FEL_HORDE.Team == TEAM_NAGA) FACTION_FEL_HORDE.Team = TEAM_LEGION;
