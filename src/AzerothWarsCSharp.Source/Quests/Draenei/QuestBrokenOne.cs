...
namespace AzerothWarsCSharp.Source.Quests.Draenei
{
  public sealed class QuestBrokenOne : QuestData
  {
    ...
    public QuestBrokenOne() : base("The Broken One",
      "The great shaman Nobundo is fighting to enable Velen && most of the Draenei to escape. If the Draenei hold out long enough, he might have time to join the survivors aboard the Exodar",
