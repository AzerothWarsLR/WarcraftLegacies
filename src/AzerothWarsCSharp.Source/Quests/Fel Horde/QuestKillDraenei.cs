...
namespace AzerothWarsCSharp.Source.Quests.Fel_Horde
{
  public sealed class QuestKillDraenei : QuestData{
    ...
    protected override string CompletionPopup => "The Draenei have been eliminated from Outland && their gold mine is ours.";

    protected override string CompletionDescription => "The Draenei rich gold mine in Tempest Keep, the faster we destroy them, the more gold will be left";
