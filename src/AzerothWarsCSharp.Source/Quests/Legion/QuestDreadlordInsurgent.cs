...
namespace AzerothWarsCSharp.Source.Quests.Legion
{
  public sealed class QuestDreadlordInsurgent : QuestData
  {
    public QuestDreadlordInsurgent() : base("Dreadlord Insurgent",
      "Varimathras has branched out && tried to take control of the Plaguelands, Sylvanas will try && make him join her cause",
    ...
    protected override void OnComplete()
    {
      ...
      CreateUnits(Holder.Player, FourCC("n04J"), GetRectCenterX(Regions.VandermarVillage),
        GetRectCenterY(gg_rct_Vandermar_Village), 270.Rect, 12);
      CreateUnits(Holder.Player, FourCC("u00D"), GetRectCenterX(Regions.VandermarVillage),
        GetRectCenterY(gg_rct_Vandermar_Village), 270.Rect, 6);
      CreateUnits(Holder.Player, FourCC("ninc"), GetRectCenterX(Regions.VandermarVillage),
        GetRectCenterY(gg_rct_Vandermar_Village), 270.Rect, 12);
      CreateUnits(Holder.Player, FourCC("u007"), GetRectCenterX(Regions.VandermarVillage),
        GetRectCenterY(gg_rct_Vandermar_Village), 270.Rect, 2);
