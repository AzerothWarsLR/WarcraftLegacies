...
namespace AzerothWarsCSharp.Source.Quests.Cthun
{
  public sealed class QuestEndlessRanks : QuestData
  {
    ...
    {
      AddQuestItem(new ObjectiveTrain(FourCC("n06I"), FourCC("o00R"), 24));
      AddQuestItem(new ObjectiveTrain(FourCC("u013"), FourCC("o00R"), 6));
      AddQuestItem(new ObjectiveTrain(FourCC("o02N"), FourCC("u01H"), 24));
      AddQuestItem(new ObjectiveTrain(FourCC("n05V"), FourCC("u01G"), 12));
      AddQuestItem(new ObjectiveTrain(FourCC("n060"), FourCC("u01G"), 12));
      AddQuestItem(new ObjectiveTrain(FourCC("h01K"), FourCC("u01H"), 8));
