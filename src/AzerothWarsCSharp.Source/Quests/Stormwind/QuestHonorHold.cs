...
namespace AzerothWarsCSharp.Source.Quests.Stormwind
{
  public sealed class QuestHonorHold : QuestData
  {
    ...
    {
      thistype this = thistype.allocate("Honor Hold", "Despite OutlandFourCC("s incredibly harsh climate,
    ...
    protected override string CompletionPopup =>
      "Honor Hold is now free from the const looming threat of Hellfire Citadel. Danath Trollbane && his people elect to rejoin the Alliance.";

    protected override string CompletionDescription =>
      "The demihero Danath Trollbane, && control of all units at Honor Hold";
