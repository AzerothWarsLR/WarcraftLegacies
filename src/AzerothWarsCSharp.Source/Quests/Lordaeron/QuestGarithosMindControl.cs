...
namespace AzerothWarsCSharp.Source.Quests.Lordaeron
{
  public sealed class QuestGarithosMindControl : QuestData
  {
    ...
    {
      thistype this =
        thistype.allocate("GarithosFourCC(" Mind - Control", "Garithos has always had a distrust of other races,
          he might be tempted to join the Scarlet MindControl.", "ReplaceableTextures\\CommandButtons\\BTNGarithos
            .blp");
    ...
    protected override string CompletionDescription =>
      "You lose everything, but will spawn with Garithos && a small army in Capital City";
    ...
    protected override void OnComplete()
    {
      ...
      CreateUnits(Holder.Player, FourCC("hkni"), GetRectCenterX(Regions.Terenas), GetRectCenterY(gg_rct_Terenas),
        270.Rect, 12);
      CreateUnits(Holder.Player, FourCC("hpea"), GetRectCenterX(Regions.Terenas), GetRectCenterY(gg_rct_Terenas),
        270.Rect, 6);
      CreateUnits(Holder.Player, FourCC("hfoo"), GetRectCenterX(Regions.Terenas), GetRectCenterY(gg_rct_Terenas),
        270.Rect, 12);
      CreateUnits(Holder.Player, FourCC("h009"), GetRectCenterX(Regions.Terenas), GetRectCenterY(gg_rct_Terenas),
        270.Rect, 2);
