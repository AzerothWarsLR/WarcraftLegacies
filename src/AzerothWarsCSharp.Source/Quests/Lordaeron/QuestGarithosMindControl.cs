...
namespace AzerothWarsCSharp.Source.Quests.Lordaeron
{
  public sealed class QuestGarithosMindControl : QuestData
  {
    ...
    {
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_H00F_PALADIN_LORDAERON, -Faction.UNLIMITED);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UPGRADE_R06Q_PALADIN_MASTER_TRAINING_LORDAERON, -Faction.UNLIMITED);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_H012_CAPTAIN_FALRIC_LORDAERON_DEMI, -Faction.UNLIMITED);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_HART_CROWN_PRINCE_OF_LORDAERON_LORDAERON, -Faction.UNLIMITED);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_HUTH_LEADER_OF_THE_SILVER_HAND_LORDAERON, -Faction.UNLIMITED);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_H01J_THE_ASHBRINGER_LORDAERON, -Faction.UNLIMITED);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_HARF_HIGH_KING_LORDAERON_HIGH_KING, -Faction.UNLIMITED);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_H009_DARK_KNIGHT_GARITHOS, 6);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_H049_RANGER_LORD_FORSAKEN, 1);
      LordaeronSetup.FactionLordaeron.ModObjectLimit(Constants.UNIT_HLGR_GRAND_MARSHAL_SCARLET, 1);
      ...
      LegendForsaken.LegendNathanos.Spawn(completingFaction.Player, new Point(9090, 8743), 110);
