...
namespace AzerothWarsCSharp.Source.Hints
{
  public class HintConfig{
    ...
    public static void Setup( ){
      ...
      Hint.Register(new Hint("Some heroes canFourCC(t be revived, && some can only be revived if (you control certain capitals when they die."));
      ...
      Hint.Register(new Hint("When a player leaves, their gold, lumber, units && hero experience are spread among their remaining allies."));
