...
namespace AzerothWarsCSharp.Template.Source.Libraries
{
    ...
    public class LegendPreDiesEventArgs
    {
        public Legend DyingLegend;
    }

    public class LegendChangesOwnerEventArgs
    {
    ...
    public class Legend
    {
        ...
        private string _deathSfx;
        private bool _alwaysPermaDies = false;
        private bool _hivemind = false;
        private group _diesWithout = null;
        private bool _capturable = false;
        ...
        public Person OwningPerson
        {
            get
            {
                return Person.ByHandle(OwningPlayer);
            }
        }
