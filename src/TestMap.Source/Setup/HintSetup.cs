...
namespace TestMap.Source.Setup
{
  public static class HintSetup
  {
    public static void Setup( ){
      ...
      Hint.Register(new Hint("When a player leaves, their gold, units and hero experience are spread among their remaining allies."));
      ...
      Hint.Register(new Hint("You can send gold to your allies using the command found in the Quests menu."));
