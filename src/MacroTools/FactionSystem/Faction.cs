  ...
  public sealed class Faction
  {
    ...
    private void DistributeUnits(IReadOnlyList<player?> playersToDistributeTo)
    {
      ...
      foreach (var unit in playerUnits)
      {
        ...
        if (!CapitalManager.UnitIsCapital(unit) && !CapitalManager.UnitIsProtector(unit) && !ControlPointManager.Instance.UnitIsControlPoint(unit) && !loopUnitType.Meta && loopUnitType.Category != UnitCategory.Portal)
        {
